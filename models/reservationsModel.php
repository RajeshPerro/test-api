...
rd.modified_at as bookingDateAndTime, t.name as tripName, t.trip_date as travelDateAndTime
FROM reservation_details rd JOIN users u ON u.id = rd.user_id
JOIN trips t ON t.id = rd.trip_id WHERE rd.`is_active` = 1 ORDER BY rd.`modified_at`";
